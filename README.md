...
git clone https://github.com/davecalleja-merkle/test-atomic-db-fix.git

# Install all required packages
cd test-atomic-db-fix && pnpm install
...
### First Time Setup
1. **Clone the repository:** `git clone https://github.com/davecalleja-merkle/test-atomic-db-fix.git`
2. **Install dependencies:** `cd test-atomic-db-fix && pnpm install`
